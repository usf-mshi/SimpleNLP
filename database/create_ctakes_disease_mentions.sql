-- Script to create ctakes disease mention table.

create table m_ct_disease_concept
(
  rowid          bigserial not null
    constraint m_ct_disease_concept_pkey
      primary key,
  hadm_id        integer
...
alter table m_ct_disease_concept owner to postgres;
